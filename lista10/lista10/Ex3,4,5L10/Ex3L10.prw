...
/*/{Protheus.doc} User Function Ex3L10
    Relatório de Compras
    @type  Function
    @author Tamíris Cordeiro
    @since 10/04/2023
    /*/
User Function Ex3L10()
...
Static Function GeraReport()
    ...
    oRel := TReport():New('Ex3L10', 'Relatório de Compras',,{|oReL| Imprime(oRel, cAlias)}, 'Esse relatório imprimirá o pedido de compras selecionados e seus itens.',.F.,,,, .T., .T.)

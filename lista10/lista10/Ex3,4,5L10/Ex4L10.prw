...
/*/{Protheus.doc} User Function Ex4L10
    Relatório de Compras com os valores totais
    @type  Function
    @author Tamíris Cordeiro
    @since 10/04/2023
    /*/
User Function Ex4L10()
...
Static Function GeraReport()
    ...
    oRel := TReport():New('Ex4L10', 'Relatório de Compras',,{|oReL| Imprime(oRel, cAlias)}, 'Esse relatório imprimirá o pedido de compras selecionado e seus itens com o valor total.',.F.,,,, .T., .T.)
